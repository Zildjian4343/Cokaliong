    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion p-0 toggled" style="background: var(--bs-primary-text-emphasis);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="index.php">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Express<br>Laundry<br>Pala-o</span></div>
                </a>
    ...
    <div class="row align-items-center no-gutters">
        <div class="col me-2">
            <div class="text-uppercase text-success fw-bold text-xs mb-1">
                <span>Earnings (annual) - <?php echo date('Y')?> </span>
            </div>
            <div class="text-dark fw-bold h5 mb-0">
                <span>₱<?php get_yearly()?></span>
            </div>
        </div>
        <div class="col-auto">
            <i class="fas fa-wallet fa-2x text-gray-300"></i>
...
<style>
    ...
    .hover-grow:hover {
        ...
        color: #28a745; /* Change the color to green on hover */
    }
